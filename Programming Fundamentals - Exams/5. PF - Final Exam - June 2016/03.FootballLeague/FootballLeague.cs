    ...
    internal class FootballLeague
    {
        private static void Main()
        {
            ...
            while (command != null && command.ToUpper() != "FINAL")
            {
                ...
                startIndex = decryptedHomeTeamName.IndexOf(key, StringComparison.Ordinal);
                endIndex = decryptedHomeTeamName.LastIndexOf(key, StringComparison.Ordinal);
                ...
                startIndex = decryptedAwayTeamName.IndexOf(key, StringComparison.Ordinal);
                endIndex = decryptedAwayTeamName.LastIndexOf(key, StringComparison.Ordinal);
